...
class spatial_dataset(Dataset):  
    ...
    def load_ucf_image(self,video_name, index):
        ...
        #path = os.path.join(self.root_dir,  'v_'+video_name, str('%05d'%(index)) + '.jpg')
...
class spatial_dataloader():
    ...
    def load_frame_count(self):
        ...
        with open('/media/dataDisk/Video/two-stream-action-recognition/dataloader/dic/frame_count.pickle','rb') as file:
...
if __name__ == '__main__':
    ...
    dataloader = spatial_dataloader(BATCH_SIZE=16, num_workers=8, 
                                path='/media/dataDisk/THUMOS14/UCF101_jpegs_256/', 
                                ucf_list='../UCF_list/',
                                ucf_split='01')
