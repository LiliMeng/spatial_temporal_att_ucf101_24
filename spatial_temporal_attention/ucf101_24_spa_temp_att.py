...
def main():
	...
	train_data_loader = get_loader(class_dict=category_dict,
	...
	test_data_loader = get_loader(class_dict=category_dict,
	...
	lstm_action = Action_Att_LSTM(input_size=2048, hidden_size=512, output_size=24, seq_len=FLAGS.num_segments).cuda() 
	...
	#log_name = "tmp"
	log_dir = os.path.join('./Conv_ucf101_24_tensorboard', log_name)
	#log_dir = "tmp"
	...
	num_step_per_epoch_train = 2293/FLAGS.train_batch_size
	num_step_per_epoch_test = 910/FLAGS.test_batch_size
	for epoch_num in range(maxEpoch):
		...
		avg_train_corrects = total_train_corrects *100 /2293
		...
		avg_test_corrects = total_test_corrects*100/910
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='ucf101_24_anno',
                        help='dataset: "ucf101_24_anno"')
